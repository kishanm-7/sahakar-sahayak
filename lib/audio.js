// ---------------------------------------------------------------------------
// Audio helpers for the voice path.
//
// The wire format is the simplest there is: raw 16-bit signed PCM, mono,
 ...
 *
 * Whisper needs a recognisable audio *file*, but the client sends bare
 ...
 *
 * OpenAI TTS hands back 24000 Hz; the voice path is standardised on
 ...
 * low-pass filter first to avoid aliasing. For speech played back in a browser
 * the difference is inaudible, and this keeps the dependency count
